 ...
 *
 *  poll_host() flushes a batch in two places, when it fills up mid-loop and
 *  again for whatever is left at the end, and both spelled out the same
 *  seventy-six lines. They differed only in indentation.
 *
